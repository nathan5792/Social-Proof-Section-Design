...
This is my solution to the [Social-Proof-Section on Frontend Mentor](https://www.frontendmentor.io/challenges/bento-grid-RMydElrlOj). Frontend Mentor challenges help you improve your coding skills by building realistic projects. 
...
## Overview
-This project is my solution to the Social-Proof-Section challenge from Frontend Mentor
...
![Social-Proof-Section](./images/social-proof-section-preview.png)
...
-Styled the layout using CSS Flex-box and CSS-Grid for alignment and responsiveness.
...
-This was by far the challenging one i have come across and have learned alot different from the others such as playing around with positions and padddings and margins, this challenge has definetely helped me to level up my skills generally. 
